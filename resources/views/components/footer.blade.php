                ...
                @if ($socialLinks)
                    <div class="flex items-center gap-x-4">
                        @foreach ($socialLinks as $link)
                            ...
                            >
                                <svg class="shrink-0 size-4" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                                    <path fill-rule="evenodd" d="{{ $link['path'] }}" clip-rule="evenodd" />
                                </svg>
