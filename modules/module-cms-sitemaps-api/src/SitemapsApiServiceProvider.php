...
final class SitemapsApiServiceProvider extends ServiceProvider
{
    public function register(): void
    {
        if ($this->app->bound(ApiResourceRegistryInterface::class)) {
            ...
            $r->registerEndpoint('sitemaps-api', new ApiEndpoint('cms/sitemaps/{entry}', SitemapsController::class, 'update', 'cms.sitemaps.update', 'PATCH', ['abilities:content:write']));
            $r->registerEndpoint('sitemaps-api', new ApiEndpoint('cms/sitemaps/{entry}', SitemapsController::class, 'delete', 'cms.sitemaps.delete', 'DELETE', ['abilities:content:write']));
