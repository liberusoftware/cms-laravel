 ...
 * model does not have.
 */
it('disables tenant resource scoping', function (): void {
    expect(RolesPermissionsFilamentPlugin::make()->isScopedToTenant())->toBeFalse();
});

it('is a Shield plugin rather than a reimplementation', function (): void {
...
it('keeps Shield\'s plugin id, so a panel cannot register both', function (): void {
