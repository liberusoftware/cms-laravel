...
namespace Liberu\Cms\MediaLibraryFilament\Resources\Pages;
...
final class ListMedia extends ListRecords
{
    ...
    {
        return [Action::make('upload')->label('Upload')->icon('heroicon-o-arrow-up-tray')->schema([
            FileUpload::make('file')->required()->storeFiles(false),
            TextInput::make('folder')->maxLength(255)->helperText('Optional sub-folder.'),
            ...
            try {
                ...
                Notification::make()->title('Upload rejected.')->body($exception->getMessage())->danger()->send();
