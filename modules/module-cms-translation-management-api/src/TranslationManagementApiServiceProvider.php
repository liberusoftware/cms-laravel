...
final class TranslationManagementApiServiceProvider extends ServiceProvider
{
    public function register(): void
    {
        ...
        $registry->registerEndpoint('translation-management-api', new ApiEndpoint('cms/translation-management/jobs/{publicId}/cancel', TranslationManagementController::class, 'cancel', 'cms.translation-management.cancel', 'POST', ['abilities:content:write']));
