...
final class WordPressMigrationRecord extends Model
{
    ...
    protected function casts(): array { return ['payload' => 'array', 'source_identifiers' => 'array', 'processed_at' => 'datetime']; }
    public function migration(): \Illuminate\Database\Eloquent\Relations\BelongsTo { return $this->belongsTo(WordPressMigration::class, 'migration_id'); }
}
