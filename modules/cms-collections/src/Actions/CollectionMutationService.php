...
final class CollectionMutationService
{
    public function create(array $attributes): Collection
    {
        if (blank($attributes['name'] ?? null)) {
            throw ValidationException::withMessages(['name' => 'Collection name is required.']);
        }
    ...
    public function createItem(Collection $collection, array $attributes): CollectionItem
    {
        if (blank($attributes['title'] ?? null)) {
            throw ValidationException::withMessages(['title' => 'Collection item title is required.']);
        }
    ...
    public function deleteItem(CollectionItem $item): void
    {
