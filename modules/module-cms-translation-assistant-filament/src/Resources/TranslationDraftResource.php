...
final class TranslationDraftResource extends Resource
{
    ...
    {
        return $table->columns([TextColumn::make('subject_type'), TextColumn::make('subject_id'), TextColumn::make('target_locale'), TextColumn::make('confidence'), TextColumn::make('status')->badge(), TextColumn::make('provider')]);
    }

    /** @return array<string, PageRegistration> */
    public static function getPages(): array
    {
        return ['index' => Pages\ListTranslationDrafts::route('/')];
    }
}
