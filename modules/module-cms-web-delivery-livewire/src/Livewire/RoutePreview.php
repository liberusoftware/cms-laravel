...
final class RoutePreview extends Component
{
    ...
    {
        if ($this->path === '' || strlen($this->path) > 2048) {
            throw ValidationException::withMessages(['path' => 'A valid delivery path is required.']);
        }
    ...
    {
        return view('module-cms-web-delivery-livewire::livewire.route-preview');
    }
}
