...
namespace Liberu\Cms\JoomlaMigration\Services;
...
final readonly class JoomlaMigrationService
{
    ...
    {
        return $this->framework->start('joomla', ['source' => $source, ...$options], $teamId);
    }
