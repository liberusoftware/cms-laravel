...
final class TranslationJob extends Model
{
    ...
    protected function casts(): array { return ['estimated_cost' => 'float', 'actual_cost' => 'float', 'metadata' => 'array', 'queued_at' => 'datetime', 'completed_at' => 'datetime']; }
    ...
    public function sourceChanges(): HasMany { return $this->hasMany(TranslationSourceChange::class, 'job_id'); }
    public function assignments(): HasMany { return $this->hasMany(TranslationAssignment::class, 'job_id'); }
}
